...
# -*- coding: utf-8 -*-
#
# numbamisc documentation build configuration file, created by
...
htmlhelp_basename = 'numbamiscdoc'
...
man_pages = [
    (master_doc, 'numbamisc', 'numbamisc Documentation',
     [author], 1)
]
